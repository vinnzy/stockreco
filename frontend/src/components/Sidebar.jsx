...
import { Home, ShieldCheck, Zap, Layers, TrendingUp, Microscope, Activity } from "lucide-react";
        ...
        <aside className="w-72 bg-slate-900 text-white p-6">
            ...
            <nav className="space-y-2">
                ...
                <div className="space-y-2 mt-2">
                    ...
                    <Item to="/recommendations/options-analyst" icon={Microscope} label="Options Analyst" />
                    <Item to="/recommendations/options-performance" icon={Activity} label="Options Performance" />
